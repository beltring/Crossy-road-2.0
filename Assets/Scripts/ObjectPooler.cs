...
public class ObjectPoolItem
{
    ...
    public ObjectPoolItem(GameObject obj, int amount, bool isExpand = true)
    {
        objectToPool = obj;
        amountToPool = Mathf.Max(amount, 2);
        shouldExpand = isExpand;
    }
}
...
public class ObjectPooler : MonoBehaviour
{
	...
	public GameObject GetPooledObject(int index)
	{
		...
		if (itemsToPool[index].shouldExpand)
		{
			...
			GameObject obj = Instantiate(itemsToPool[index].objectToPool) as GameObject;
			obj.SetActive(false);
